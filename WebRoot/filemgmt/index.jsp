...
<head>
<base href=<%=basePath%>>
<title>文件审核平台 - Windows 小游戏研究学会</title>
...
function ChangeMeeting(){
	...
	document.getElementById("annlist").src = "filemgmt/filelist.jsp?meeting=" + meetingId;
}
</script>
</head>
...
<iframe id="annlist" src="filemgmt/filelist.jsp" width="100%" height="500px" frameborder="0"></iframe>
				</td>
			</tr>
			<tr>
